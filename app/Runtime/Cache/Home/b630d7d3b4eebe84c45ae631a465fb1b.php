  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="case_add" method="post" action="<?php echo U('cases/caseAdd');?>" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="link" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
  ...
  $(function(){
    var app = {
      data: {
        ...
        caseAddUrl : "<?php echo U('cases/caseAdd');?>",
      ...
      eventInit: function(){
        var app = this;
          ...
          $('#case_add').on('submit', function(event) {
            event.preventDefault();
            /* Act on the event */
            app.submitForm();
          });
      ...
      submitForm: function(){
        ll.ajax({
          url: app.data.caseAddUrl,
          data: ll.getFormData('#case_add'),
          isFormData: true,
          success: function(){
            var ops = {
              text: '添加成功',
