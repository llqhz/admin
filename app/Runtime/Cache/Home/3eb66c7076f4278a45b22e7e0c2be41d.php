  ...
  <head>
    ...
    <style type="text/css">
        #div-pic {
            ...
            background-image: url("<?php echo getImgPath($li['img']);?>");
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="case_edit" method="post" action="<?php echo U('cases/caseAdd');?>" data-parsley-validate class="form-horizontal form-label-left">
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">案例标题 <span class="required">*</span>
            </label>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <input type="hidden" name="id" value="<?php echo ($li["id"]); ?>" hidden>
              <input type="text" name="title" value="<?php echo ($li["title"]); ?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <select class="select2_multiple form-control" name="parentId[]" tabindex="-1" multiple="multiple">
                <?php if(is_array($ops)): foreach($ops as $key=>$op): ?><option value="<?php echo ($op["id"]); ?>" <?php echo in_array($op['id'],$items)?'selected':'';?>><?php echo ($op["name"]); ?></option><?php endforeach; endif; ?>
              </select>
            </div>
            <p class="help-block"> &nbsp;&nbsp;&nbsp;按住 <code>Ctrl</code> 键多选</p>
          </div>

          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">案例简介 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="detail" value="<?php echo ($li["detail"]); ?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>

          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">案例图片 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <button type="button" id="btn-up-pic" class="btn btn-warning btn-sm">上传图片</button>
              &nbsp;&nbsp;
              <span id="span-fileName"><?php echo ($li['img']); ?></span>
              <input class="hidden" type="file" disabled="disabled" id="input-pic" accept="image/*" name="pic">
              <input type="text" name="thumb" value="<?php echo ($li['img']); ?>" id="input-thumb" hidden="" readonly="">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">案例链接 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="link" value="<?php echo ($li["link"]); ?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
              <input type="number" name="corder" value="<?php echo ($li["corder"]); ?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
...
<script type="text/javascript">
  $(function(){
    var app = {
      data: {
        uploadImgUrl: "<?php echo U('cases/uploadImg');?>",
        caseEditUrl : "<?php echo U('cases/caseEdit');?>",
        jumpUrl: "<?php echo U('cases/clists');?>",
      },
      init : function(){
        app.clicktoupload();
        app.droptoupload();
      ...
      eventInit: function(){
        var app = this;
          /*提交*/
          $('button[type=submit]').on('click2', function(event) {
            event.preventDefault();
            /* Act on the event */

          });

          $('#case_edit').on('submit', function(event) {
            event.preventDefault();
            /* Act on the event */
            app.submitForm();
          });
      ...
      clicktoupload : function () {
        $("#btn-up-pic").click(function(event) {
          ...
          $("#input-pic").change(function(event) {
      ...
      submitForm: function(){
        ll.ajax({
          url: app.data.caseEditUrl,
          data: ll.getFormData('#case_edit'),
          isFormData: true,
          success: function(){
            var ops = {
              text: '修改成功',
