...
<div class="">
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          <div class="input-group">
            <input type="text" id="searchWord" value="<?php echo ($_GET['word']); ?>" class="form-control" placeholder="输入关键词">
              ...
              <table class="table table-striped table-bordered  table-condensed table-hover "  style="">
                ...
                <tbody>
                  ...
                  <?php if(is_array($lists)): foreach($lists as $key=>$li): ?><tr data-id="<?php echo ($li["id"]); ?>">
                    ...
                    <td class=" "><?php echo transKindsName($li['kind']);?></td>
                    <td class="td-mw" ><?php echo ($li["title"]); ?></td>
                    <td class="td-mw" ><?php echo ($li["detail"]); ?></td>
                    <td class=" "><img src="<?php echo getImgPath($li['img']);?>" alt="<?php echo ($li["img"]); ?>"></td>
                    <td class="td-mw"><?php echo ($li["link"]); ?></td>
                    ...
                    <td class=" last">
                        ...
                        <a href="<?php echo ($li["link"]); ?>" title="预览"><i class="fa fa-eye"></i> </a> |
  ...
  <script>
    $(function(){
      var app_list = {
        data: {
          changeStatusUrl : '<?php echo U("cases/changeStatus");?>',
          removeCaseUrl : '<?php echo U("cases/removeCase");?>',
          editCaseUrl : '<?php echo U("cases/editCase",["id"=>"__ID__"]);?>',
          updateOrderUrl : '<?php echo U("cases/updateOrder");?>',
          deleteAllUrl : '<?php echo U("cases/deleteAll");?>',
