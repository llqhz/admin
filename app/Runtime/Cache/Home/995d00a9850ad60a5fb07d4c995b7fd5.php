              ...
              <table class="table table-striped table-bordered  table-condensed table-hover "  style="">
                ...
                <tbody>
                  ...
                  <?php if(is_array($lists)): foreach($lists as $key=>$li): ?><tr data-id="<?php echo ($li["id"]); ?>">
                    ...
                    <td class=" "><img src="<?php echo ($li["img"]); ?>" alt=""></td>
                    <td class=" "><?php echo ($li["name"]); ?></td>
                    <td class=" "><?php echo ($li["mobile"]); ?></td>
                    <td class=""><?php echo ($li["email"]); ?></td>
                    <td class="td-mw"> <?php echo ($li["password"]); ?> </td>
