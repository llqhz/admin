...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form id="news_edit" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea class="resizable_textarea form-control" name="detail" placeholder="这里是新闻的简介" style="max-width: 100%; height: 100px;"> <?php echo ($li["detail"]); ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10 col-sm-6 col-xs-12">
              ...
              <div id="summernote-content" class="hidden">
                <?php echo ($li["content"]); ?>
              </div>
            </div>
          </div>
...
<link rel="stylesheet" href="/Public/sn/dist/summernote.css">
<script src="/Public/sn/dist/summernote.js"></script>
...
<script type="text/javascript">
  ...
  $(function(){
    var app = {
      data: {
        uploadImgUrl: "<?php echo U('news/uploadImg');?>",
        newsAddUrl : "<?php echo U('news/newsEdit');?>",
        jumpUrl: "<?php echo U('news/nlists');?>",
      },
      init : function(){
        app.clicktoupload();
        app.droptoupload();
      ...
      eventInit: function(){
        var app = this;
          $('#news_edit').on('submit', function(event) {
          ...
          //初始化summernote
          $('.summernote').summernote('code',$('#summernote-content').html());
      },
