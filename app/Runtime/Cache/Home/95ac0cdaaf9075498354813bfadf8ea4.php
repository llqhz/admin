...
<div class="">
    <div class="page-title">
      ...
      <div class="title_right">
        <span class='small'>
          <input class="datetimepicker" name="t_start" id="time-start" value="<?php echo transTime($_GET['t_s']);?>" placeholder="开始时间" type="text">
          <input class="datetimepicker" name="t_end" id="time-end" value="<?php echo transTime($_GET['t_e']);?>" placeholder="结束时间" type="text">
        </span>
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          <div class="input-group">
            <input type="text" class="form-control" id="searchWord" value="<?php echo ($_GET['word']?:''); ?>"  placeholder="输入关键词">
              ...
              <table class="table table-striped table-bordered  table-condensed table-hover "  style="">
                ...
                <tbody>
                  ...
                  <?php if(is_array($lists)): foreach($lists as $key=>$li): ?><tr data-id="<?php echo ($li["id"]); ?>">
                    ...
                    <td class=" "><input type="number" name="" value="<?php echo ($li["corder"]); ?>" placeholder=""></td>
                    <td class=" "><?php echo ($li["id"]); ?></td>
                    <td class=" td-mw"><?php echo ($li["title"]); ?></td>
                    <td class=" td-mw"><?php echo ($li["detail"]); ?></td>
                    <td class=" ">
                      <img src="<?php echo getImgPath($li['img']);?>" alt="">
                    </td>
                    <td class=""><?php echo date('Y-m-d<b\r> H:i:s',$li['ctime']);?></td>
                    <td class=" ">
                    ...
                    <td class=" ">
                        <?php echo getNewsHtmlTime($li['id']);?>
                    </td>
                    <td class=" last">
...
<script src="https://cdn.bootcss.com/jquery-datetimepicker/2.5.16/jquery.datetimepicker.js"></script>
  <script>
    $(function(){
      var app_list = {
        data: {
          changeStatusUrl : '<?php echo U("news/changeStatus");?>',
          removeNewsUrl : '<?php echo U("news/removeNews");?>',
          updateOrderUrl : '<?php echo U("news/updateOrder");?>',
          deleteAllUrl : '<?php echo U("news/deleteAll");?>',
          searchWordUrl : '<?php echo U("news/nlists",["word"=>"__WORD__"]);?>',
          editNewsUrl : '<?php echo U("news/editNews",["id"=>"__ID__"]);?>',
          viewNewsUrl : '<?php echo U("news/viewNews",["id"=>"__ID__"]);?>',
          refreshNewsUrl : '<?php echo U("news/refreshNews",["id"=>"__ID__"]);?>',
        },
        init: function(){
          this.eventInit();
        },
